              ...
              return (
                <div key={st} style={{marginBottom:16}}>
                  ...
                  {group.map(r=>{
                    ...
                    return (
                      <div key={r.id} style={{background:"#fff",borderRadius:8,border:"1px solid #e8e0d5",padding:"8px 10px",marginBottom:6,display:"flex",alignItems:"center",gap:8}} onClick={()=>setSelectedRes(r)}>
